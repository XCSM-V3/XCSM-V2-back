    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_url', models.ImageField(blank=True, null=True, upload_to='photos_profil/', verbose_name='Photo URL')),
                ...
                ('type_compte', models.CharField(choices=[('ADMIN', 'Administrateur'), ('ENSEIGNANT', 'Enseignant'), ('ETUDIANT', 'Etudiant')], max_length=20, verbose_name='Type de Compte')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.TextField(blank=True, null=True, verbose_name='Liste Permissions')),
            ],
        ),
        migrations.CreateModel(
            name='Enseignant',
